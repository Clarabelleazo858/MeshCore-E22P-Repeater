...
uint32_t StaticPoolPacketManager::getOutboundDropCount() const {
  return outbound_drops;
}

uint32_t StaticPoolPacketManager::getInboundDropCount() const {
  return inbound_drops;
}

uint32_t StaticPoolPacketManager::getAllocFailCount() const {
  return alloc_fails;
}
