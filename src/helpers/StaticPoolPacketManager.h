...
public:
  ...
  uint32_t getOutboundDropCount() const override;
  uint32_t getInboundDropCount() const override;
  uint32_t getAllocFailCount() const override;
