...
public:
  ...
  virtual uint32_t getOutboundDropCount() const { return 0; }
  virtual uint32_t getInboundDropCount() const { return 0; }
  virtual uint32_t getAllocFailCount() const { return 0; }
